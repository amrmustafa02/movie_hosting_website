class GetMoviesBody {
  ...
  GetMoviesBody({this.page, this.results, this.totalPages, this.totalResults});

  GetMoviesBody.fromJson(Map<String, dynamic> json) {
    if (json["page"] is num) {
      page = json["page"];
    }
...
class Results {
  ...
  Results.fromJson(Map<String, dynamic> json) {
    ...
    if (json["vote_average"] is num) {
      voteAverage = json["vote_average"];
    }
    if (json["vote_count"] is num) {
